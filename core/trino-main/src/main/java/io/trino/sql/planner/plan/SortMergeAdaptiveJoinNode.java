...
@Immutable
public class SortMergeAdaptiveJoinNode
        extends PlanNode
{
            ...
            @JsonProperty("reorderJoinStatsAndCost") Optional<PlanNodeStatsAndCostSummary> reorderJoinStatsAndCost)
    {
        ...
        Set<Symbol> leftSymbols = ImmutableSet.copyOf(leftUp.getOutputSymbols());
    ...
    @JsonProperty("leftUp")
    public PlanNode getLeftUp()
    {
        return leftUp;
    }

    @JsonProperty("leftDown")
    public PlanNode getLeftDown()
    {
        return leftDown;
    }
    ...
    {
        return ImmutableList.of(leftUp, leftDown, rightUp, rightDown);
    }
    ...
    {
        return visitor.visitSortMergeAdaptiveJoin(this, context);
    }

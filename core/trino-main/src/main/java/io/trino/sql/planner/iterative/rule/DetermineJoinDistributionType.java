        ...
        implements Rule<JoinNode>
{
    ...
    public Result apply(JoinNode joinNode, Captures captures, Context context)
    {
        ...
        // the joinDistributionType is Broadcast but a join is right join thus a partitioned join is generated via
        ...
        if (calculatedJoinDistributionType.isEmpty()) {
    ...
    private JoinNode getSizeBasedJoin(JoinNode joinNode, Context context, boolean allowReplicated, boolean allowPartitioned)
    {
        ...
        return getSyntacticOrderJoin(joinNode, context, allowReplicated, allowPartitioned);
    }
    ...
    private JoinNode getSyntacticOrderJoin(JoinNode joinNode, Context context, boolean allowReplicated, boolean allowPartitioned)
    {

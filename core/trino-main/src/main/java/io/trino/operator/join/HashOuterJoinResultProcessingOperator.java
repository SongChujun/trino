...
//            outputPageBuffer.add(joinResult);
            ...
            implements OperatorFactory
    {
        ...
        @Override
        public HashOuterJoinResultProcessingOperator createOperator(DriverContext driverContext)
        {
            checkState(!closed, "Factory is already closed");
            OperatorContext operatorContext = driverContext.addOperatorContext(operatorId, planNodeId, HashOuterJoinResultProcessingOperator.class.getSimpleName());
            Integer localPartitioningIndex = driverContext.getLocalPartitioningIndex();
            return new HashOuterJoinResultProcessingOperator(operatorContext, isInnerJoin,

...
public class OffloadSortJoinOperator
        implements Operator
{
    public static class OffloadSortJoinOperatorFactory
            implements OperatorFactory
    {
        ...
        public OffloadSortJoinOperatorFactory(
                int operatorId,
        ...
        public Operator createOperator(DriverContext driverContext)
        {
            ...
            PagesIndex leftPagesIndex = upPagesIndexPair.get(0);
            ...
            SortMergePageBuilder pageBuilder = new SortMergePageBuilder(leftPagesIndex, rightUpPagesIndex, leftOutputTypes, rightOutputTypes, leftOutputChannels, rightOutputChannels);
            return new OffloadSortJoinOperator(operatorContext, leftMergeChannels, rightMergeChannels, leftPagesIndex, rightUpPagesIndex, rightDownPagesIndex,
    ...
    private static final Logger log = Logger.get(OffloadSortJoinOperator.class);

    public OffloadSortJoinOperator(OperatorContext operatorContext,
            List<Integer> leftMergeChannels,
            List<Integer> rightMergeChannels,
    ...
    {
        PagesIndex upPagesIndex;

        PagesIndex downPagesIndex;

        SortOperator.SortOperatorFactory.Mode mode;

        public MergeTask(PagesIndex upPagesIndex, PagesIndex downPagesIndex, SortOperator.SortOperatorFactory.Mode mode)
        {
            this.upPagesIndex = upPagesIndex;
            this.downPagesIndex = downPagesIndex;
            this.mode = mode;
        }
        ...
        public Integer call()
        {
            upPagesIndex.mergePagesIndex(downPagesIndex, mode);
            return 1;
        }
    }
